-- ========================================
-- QUERY MULTIDIMENSIONAL PARA ANÁLISE ECONÔMICA (V2 - CORRIGIDA)
-- Versão: 2.0
-- Data: 30/11/2025
-- Descrição: Consulta dados econômicos, sociais, territoriais e ambientais
--            CORREÇÃO: Remove colunas inexistentes (t.population, t.geometry)
-- ========================================
...
-- INCLUI POPULAÇÃO (que vem de social_indicators, não de territories)
social_data AS (
  SELECT 
    si.territory_id,
...
-- ========================================
--
-- 1. REMOVIDO: t.population (coluna não existe em territories)
--    ADICIONADO: sd.population (vem de social_indicators)
--
-- 2. REMOVIDO: t.geometry (coluna não existe, existe t.coordinates mas não é necessária)
--
-- 3. CORRIGIDO: Nomes de colunas em territorial_indicators:
--    - road_network_km (não road_network_km)
--    - paved_roads_km (não paved_roads_km)
--
-- 4. MANTIDO: Todas as outras colunas conforme schema real
--
-- RESULTADO: Query funcional que retorna dados multidimensionais completos
