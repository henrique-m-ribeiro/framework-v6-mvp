-- ========================================
-- QUERY MULTIDIMENSIONAL PARA ANÁLISE ECONÔMICA (V3 - SCHEMA REAL)
-- Versão: 3.0
-- Data: 30/11/2025
-- Descrição: Query baseada no SCHEMA REAL do banco Neon
--            Usa apenas colunas que realmente existem
-- ========================================
...
WITH 
-- 1. DADOS TERRITORIAIS (Base geográfica)
territory_data AS (
  SELECT 
...
-- ========================================
-- SCHEMA REAL VALIDADO (30/11/2025)
-- ========================================
--
-- TERRITORIES:
...
--   - id, territory_id, year, urban_area_km2, rural_area_km2, infrastructure_metrics (JSON)
--
-- ECONOMIC_INDICATORS:
...
--     active_companies_count, municipal_tax_revenue
--
-- SOCIAL_INDICATORS:
