"""
Teste do Ciclo de Aprendizagem Evolutiva

Este script testa o ciclo completo de aprendizagem, simulando:
1. Criação de uma nova análise
2. Busca de análises similares
3. Comparação e síntese (simulada)
4. Atualização da memória e aprendizado
...
from learning_cycle import LearningCycle, ExpertiseLevel
...
def test_learning_cycle():
    ...
    try:
        ...
        """, (
            ...
            0.85,
            '2024-Q1',
            json.dumps(['IBGE', 'Prefeitura de Palmas']),
        ...
        # 3. Buscar análises similares (simulação)
        ...
        if len(similar_analysis_ids) == 0:
            ...
            # Criar análises de exemplo para o teste
            for i in range(3):
