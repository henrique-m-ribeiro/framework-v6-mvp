...
**Duração Total Estimada:** 15-18 sessões (20-27 horas de trabalho)**Período:** 6-9 semanas (considerando sessões curtas de 1-1.5h)
...
**Tempo:** 1-1.5 horas**Sessões:** 1 sessão
...
**Tempo:** 1-2 horas**Sessões:** 1-2 sessões
...
**Tempo:** 2-4 horas**Sessões:** 2-3 sessões
...
- Criar conta no n8n Cloud ([https://n8n.io](https://n8n.io) )
...
- Componentes:
    ...
    1. **HTTP Request:** Chamar API IBGE Sidra (PIB)
    1. **Code:** Processar JSON, transformar dados
    1. **PostgreSQL:** Inserir em fato_pib
    1. **IF:** Verificar se dados novos ou atualização
    1. **Notification:** Enviar email/Slack se erro
...
**Tempo:** 4-6 horas**Sessões:** 3-4 sessões
...
**Tempo:** 2-3 horas**Sessões:** 2 sessões
...
✅ Todas as 6 abas funcionando perfeitamente✅ Chat IA respondendo corretamente✅ Banco de dados populado (140 entidades, 10.000+ registros)✅ n8n workflows funcionando (coleta automática)✅ Sistema RAG gerando análises relevantes✅ Exportação PDF/CSV funcionando✅ Responsividade validada (desktop, tablet, mobile)✅ Performance adequada (< 3s carregamento)✅ Zero bugs críticos✅ Documentação completa✅ Testes com usuários realizados (opcional)

### Como Publicar?

1. Voltar às configurações de "Production database settings"

1. Verificar configurações (Opção 1 marcada)

1. Clicar em **"Publish now"**

1. Replit cria banco de produção

1. Deploy automático

1. URL pública gerada

1. Compartilhar com gestores públicos
...
1. Instalar extensões (PostGIS, pgvector)
...
**Tempo estimado:** 1-1.5 horas**Quando:** Após Replit Agent concluir geração do código
