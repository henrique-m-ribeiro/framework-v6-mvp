...
Estou desenvolvendo o **Framework de Inteligência Territorial V6.0**, um sistema multi-agentes para análise de políticas públicas no estado do Tocantins, Brasil. O projeto integra:
